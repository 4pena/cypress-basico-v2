...
it('Zanthus SAT - Saida de operador', function() {
...
it('Zanthus SAT - Reducao Z', function() {
...
it('Zanthus SAT - Abertura de Caixa', function(){
    cy.get('#campoinput-1260-inputEl')
        .type('151')
...
it('Zanthus SAT - Entrada de Operador', function(){
